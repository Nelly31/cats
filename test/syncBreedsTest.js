...
describe('#breedDetails', () => {
  ...
  it('returns breed details for the Balinese', () => {
    ...
    console.log(expectedDesc2, balinese);
  });
  it('returns undefined when there is no description for the breed name provided i.e tabby', () => {
    const expectedDesc3 = undefined;
    const tabby = breedDetails('Tabby');
    console.log(expectedDesc3, tabby);
  });
});
